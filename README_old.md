# CMPforOpenSSL (cmpossl) - this is the meanwhile unmaintained former README.md
...
As of November 2024, upstream contribution of the latest CMP features
to OpenSSL is nearly finished.
